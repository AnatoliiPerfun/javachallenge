...
public class LetterPoints {
    ...
    public static void main(String[] args) {
        System.out.println("Enter any word " + "let`s count points: ");
        Scanner scanner = new Scanner(System.in);
        String word = scanner.nextLine();
        System.out.println("Your word " + word + " will earn" + wordScoreCalc(word));
    }
    private static final Map<Character, Integer> letterPoints =
            Map.ofEntries(Map.entry('A', 1),
                    ...
                    Map.entry( 'Y', 4),
                    Map.entry( 'Z', 10));
    static int wordScoreCalc(String word) {
        ...
        normalized.chars()
                ...
                .forEachOrdered(letter -> {
                    if (letterPoints.containsKey(letter)) {
                        ...
                        System.out.println("oops! looks like you need " +
                                " to add " + letter);
                    }
                });
        return score.get();
